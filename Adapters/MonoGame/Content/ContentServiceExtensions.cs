...
namespace MonoGameLibrary.Adapters.MonoGame.Content {
    ...
    public static class ContentServiceExtensions {
        ...
        /// <param name="serviceContent">The content service (must be a <see cref="ContentService"/>). </param>
        ...
        /// <exception cref="InvalidOperationException">Thrown if the service is not a <see cref="ContentService"/>. </exception>
        ...
        public static T FromFile<T>(this IContentService serviceContent, string pathFile) where T : class {
            ...
            ContentService serviceMonoGameContent = serviceContent as ContentService;
            if (serviceMonoGameContent == null) {
                throw new InvalidOperationException(
                    "This extension requires a ContentService. " +
